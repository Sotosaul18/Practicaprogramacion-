...
# Crear pestañas para separar secciones
tab1, tab2, tab3 = st.tabs(["Calculadora de Áreas", "Visualización", "Funciones Trigonométricas"])

# --- Parte 1: Calculadora de Áreas y Perímetros ---
with tab1:
    st.title("📐 Calculadora de Áreas y Perímetros")
